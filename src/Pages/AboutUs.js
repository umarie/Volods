        ...
        <div className="flex flex-col justify-center items-center pt-24">
          ...
          <div className="flex flex-col justify-center items-center mt-10 md:mt-16 md:flex-row">
            <div className="flex flex-col justify-center items-center mt-10 md:mt-0 ">
              <img src={person2} className='w-28 md:mt-3 hover:opacity-30 ' alt="robot" />
            ...
            <div className="flex flex-col justify-center items-center mt-10 md:mt-0 md:ml-20">
              <img src={person1} className='w-28 hover:opacity-30 ' alt="robot" />
            ...
            <div className="flex flex-col justify-center items-center mt-10 md:mt-0 md:ml-20 ">
              <img src={person3} className='w-28 hover:opacity-30 ' alt="robot" />
